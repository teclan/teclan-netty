...
public class FileServerHanlder extends ChannelInboundHandlerAdapter {
    ...
    private static final HashMap<String, FileInfo> CACHES = new HashMap<String, FileInfo>();
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (fileInfo.isDir()) {
            ...
            if (!CACHES.containsKey(id)) {
                String dstFileName = fileInfo.getDstFileName();
                fileInfo.setTmpFileName(dstFileName + ".swap");
                CACHES.put(id, fileInfo);

                FileUtils.createIfNeed(fileInfo.getTmpFileName());
            }
