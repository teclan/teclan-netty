...
public class FileInfoHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(FileInfoHandler.class);


    public static void write(FileInfo fileInfo) throws InterruptedException, IOException {
    ...
    public static void send(ChannelHandlerContext ctx,Object o) throws Exception {
        if(ctx==null){
